...
TRANSLATIONS = {
    'en': {
        ...
        "local_training_config": "Local Training Configuration",
        "local_epochs": "Local Training Epochs",
        "local_epochs_help": "Number of training epochs each client performs on local data before sending to fog nodes",
        ...
        "analysis_complete": "Analysis Complete",
        "risk_analysis_completed": "Risk analysis completed",
        "using_converged_global_federated_model": "Using converged global federated model",
        "model_converged_after_rounds": "Model converged after {rounds} rounds",
        "model_prediction_probability": "Model prediction probability: {score:.3f}",
        "processing_patient_data": "Processing Patient Data",
        "analyzing_predictions": "Analyzing Risk Predictions",
        ...
        "high_glucose_level": "High glucose ({glucose} mg/dL)",
        "normal_glucose_levels": "Normal glucose levels",
        "obesity_bmi": "Obesity (BMI: {bmi})",
        "overweight_bmi": "Overweight (BMI: {bmi})",
        "healthy_weight": "Healthy weight",
        "age_45_years": "Age ≥45 years",
    ...
    'fr': {
        ...
        "local_training_config": "Configuration d'Entraînement Local",
        "local_epochs": "Époques d'Entraînement Local",
        "local_epochs_help": "Nombre d'époques d'entraînement que chaque client effectue sur les données locales avant d'envoyer aux nœuds fog",
        ...
        "convergence_summary": "Résumé de Convergence",
        "convergence_score": "Score de Convergence",
        "stability_score": "Score de Stabilité",
        "improvement_rate": "Taux d'Amélioration",
        "status_converging": "En Convergence",
        "stability_high": "Élevée",
        ...
        "analysis_complete": "Analyse Terminée",
        "risk_analysis_completed": "Analyse de risque terminée",
        "using_converged_global_federated_model": "Utilisation du modèle fédéré global convergé",
        "model_converged_after_rounds": "Modèle convergé après {rounds} rondes",
        "model_prediction_probability": "Probabilité de prédiction du modèle: {score:.3f}",
        ...
        "high_glucose_level": "Glucose élevé ({glucose} mg/dL)",
        ...
        "training_control": "Contrôle d'Entraînement",
        "confusion_matrix_analysis": "Analyse de Matrice de Confusion",
        "select_medical_facility_detailed_analysis": "Sélectionner l'Établissement Médical pour l'Analyse Détaillée",
        "medical_station": "Station Médicale",
        "select_training_round": "Sélectionner la Ronde d'Entraînement",
        "round": "Ronde",
        "classification_metrics": "Métriques de Classification",
        "no_diabetes": "Pas de Diabète",
        "diabetes": "Diabète",
        "precision": "Précision",
        "recall": "Rappel",
        "f1_score": "Score F1",
        "performance_insights": "Aperçus de Performance",
        "sensitivity_recall": "Sensibilité (Rappel)",
        "specificity": "Spécificité",
        "ppv_precision": "VPP (Précision)",
        "npv": "VPN",
        "patient_information": "Informations Patient",
        "enter_patient_information": "Entrez les informations du patient pour l'évaluation du risque de diabète:",
        "risk_prediction": "Prédiction de Risque",
        "feature_analysis": "Analyse des Caractéristiques",
        "population_comparison": "Comparaison de Population",
        "anomaly_detection_outlier_analysis": "Détection d'Anomalies et Analyse des Valeurs Aberrantes",
        "performance_outliers": "Valeurs Aberrantes de Performance",
        "facility_performance_ranking": "Classement des Performances des Établissements",
        "convergence_analysis": "Analyse de Convergence",
        "convergence_trends": "Tendances de Convergence",
        "select_facility_trend_analysis": "Sélectionner l'Établissement pour l'Analyse des Tendances",
        "convergence_summary": "Résumé de Convergence",
        "convergence_score": "Score de Convergence",
        "status_converging": "Statut: Convergent",
        "stability_score": "Score de Stabilité",
        "stability_high": "Stabilité: Élevée",
        "improvement_rate": "Taux d'Amélioration",
        "trend_stable": "Tendance: Stable",
        "performance_improvement_analysis": "Analyse d'Amélioration des Performances",
        "individual_patient_risk_assessment": "Évaluation du Risque Patient Individuel",
        "patient_risk_analysis": "Analyse du Risque Patient",
        "model_converged_rounds_accuracy": "Modèle convergé après {rounds} rondes avec {accuracy} de précision",
        "model_prediction_probability": "Probabilité de prédiction du modèle: {probability}",
        "risk_level": "Niveau de Risque",
        "low_risk": "Risque Faible",
        "risk_score": "Score de Risque",
        ...
        "continue_healthy_lifestyle": "Continuer un mode de vie sain",
        "routine_screening_guidelines": "Dépistage de routine selon les directives",
        "monitor_risk_factors_periodically": "Surveiller les facteurs de risque périodiquement",
        "risk_factors_analysis": "Analyse des Facteurs de Risque",
        "risk_factors": "Facteurs de Risque:",
        "overweight_bmi": "Surpoids (IMC: {bmi})",
        "risk_meter": "Mesure de Risque",
